...
import { getUserByName, topupUserAccount } from "../../../api/user-api";
...
const ServicePacage = () => {
 ...
 const handleTopup = async () => {
  ...
  try {
    const res = await topupUserAccount(payload);
    if (res?.success) {
      Swal.fire({
        icon: "success",
  ...
  return (
    <div className="min-h-screen   text-white p-10 text-[1.4rem] leading-relaxed">
      <div className="max-w-7xl border p-4 rounded-xl !shadow-xl !border-gray-600 mx-auto">
            ...
            <div className="backdrop-blur-xl  border-b border-white/10 rounded-3xl p-4 shadow-2xl">
              <div className="flex items-center gap-8 mb-10 pb-10 border-b border-white/10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-400 text-2xl">{userData.name}</p>
              ...
              {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="backdrop-blur-sm bg-white/5 rounded-2xl p-6 border border-white/10">
                  <p className="text-gray-400 text-xl mb-2">Role</p>
                  <p className="text-white font-semibold text-2xl capitalize">
                    {userData.role}
                  </p>
                </div>
                <div className="backdrop-blur-sm bg-white/5 rounded-2xl p-6 border border-white/10">
                  <p className="text-gray-400 text-xl mb-2">Email Verified</p>
        ...
        <div className="backdrop-blur-xl  border-b border-white/10 rounded-3xl p-10 shadow-2xl">
          <div className="mb-6">
            ...
            <p className="text-gray-400 text-2xl">
              Activate the premium package for this user. Standard rate: $125
              per activation.
            </p>
          </div>
          ...
          <div className="backdrop-blur-sm bg-white/5 rounded-2xl p-6 border border-white/10 mb-8">
            <div className="flex justify-between items-center">
              <span className="text-gray-300 text-2xl">Package Amount:</span>
              <span className="text-3xl font-bold text-blue-400">$125.00</span>
            </div>
          </div>
          ...
          <p className="text-gray-500 text-xl text-center mt-6">
            This action will activate the premium package for the selected user.
          </p>
        </div>
      </div>
    </div>
