...
const TopupPackageWalletHistory = () => {
    ...
    const fetchdata = async () => {
        try {
            setLoading(true);
            const response = await getTopupPackageWalletHistory();
            if (response?.success) {
    ...
    const columns = [
        ...
        { label: "Wallet Type", key: "wallet", render: (val) => val === "mainWallet" ? "Main Wallet" : "Package Wallet" },
        {
...
export default TopupPackageWalletHistory
