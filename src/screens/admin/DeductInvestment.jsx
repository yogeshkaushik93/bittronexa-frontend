...
import { deductFundByAdmin, deductInvestmentAmount, getUserByName } from "../../api/admin-api";
import Swal from "sweetalert2";
import ReusableForm from "../../components/ui/ReusableForm";
import { Coins, Wallet } from "lucide-react";

const DeductInvestment = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const res = await deductInvestmentAmount(payload);
            if (res?.success) {
                Swal.fire({
                    icon: "success",
                        ...
                        <div className="backdrop-blur-xl  border-b border-white/10 rounded-3xl p-4 shadow-2xl">
                            <div className="flex items-center gap-8 mb-10 pb-10 border-b border-white/10">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-4xl font-bold">{userData.username}</h3>
                                        ...
                                        <p className="text-gray-300 text-2xl">Total Investment : <span className="text-green-500">${userData.totalInvestment}</span></p>
                                </div>
                            </div>
                            ...
                            <div className="backdrop-blur-xl  border-b border-white/10 rounded-3xl p-4 shadow-2xl">
                                ...
                                <button
                                    ...
                                    disabled={submitLoading || !formData.amount}
...
export default DeductInvestment;
