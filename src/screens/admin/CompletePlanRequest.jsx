...
import { getCompletePlans } from "../../api/payment-api";

const CompletePlanRequest = () => {
  ...
  const fetchWithdrawalHistory = async () => {
    try {
      setLoading(true);
      const response = await getCompletePlans();
  ...
  return (
    <>
      {loading && <PageLoader />}
      <div className="WithdrawalReport CompletePlanRequest martop">
...
export default CompletePlanRequest;
