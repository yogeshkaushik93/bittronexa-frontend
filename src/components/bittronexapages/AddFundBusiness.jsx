...
const AddFundBusiness = () => {
    ...
    const handleSubmit = async () => {
        try {
            if (!formData.username || !formData.amount || !formData.position) {
                return Swal.fire({
                    icon: "error",
                    title: "Error",
            ...
            const response = await addFundBusinessByAdmin(payload);
            if (response?.success) {
                Swal.fire({
                    icon: "success",
                    title: "Success",
                ...
                setFormData({ username: "", amount: "", position: "" });
                setSearchedUser(null);
            }
        } catch (error) {
            console.log("error in add fund business", error);
            Swal.fire({
                icon: "error",
                title: "Error",
                text: error?.response?.data?.message || "Failed to add funds",
            });
        } finally {
            setLoading(false);
        }
...
export default AddFundBusiness;
